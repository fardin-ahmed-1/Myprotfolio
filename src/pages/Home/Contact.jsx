...
const Contact = () => {
    ...
    return (
        <div className='border border-bordertrs bg-backgroundtrs py-10 mt-16 rounded-md'>
            <Container>
                <div className=''>
                    <SectionLable title='Got a project?' />
                </div>
                <div className='flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16 py-10 '>
                    <div className='w-full md:w-56 lg:w-96'>
